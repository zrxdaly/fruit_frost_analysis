...
np.save("HAR/DO_R060.npy", DO_R060)
np.save("HAR/DO_R080.npy", DO_R080)
np.save("HAR/DO_R096.npy", DO_R096)
np.save("HAR/DO_R120.npy", DO_R120)
np.save("HAR/DO_R160.npy", DO_R160)
np.save("HAR/DO_R192.npy", DO_R192)
np.save("HAR/DO_R240.npy", DO_R240)
np.save("HAR/DO_R320.npy", DO_R320)
np.save("HAR/DO_R480.npy", DO_R480)
