...
SUM_R160_N_H = D2_N(R160, 0, T0)
SUM_R160_N = np.mean(SUM_R160_N_H)
...
SUM_R288_N_H = D2_N(R288, 0, T0)
SUM_R288_N = np.mean(SUM_R288_N_H)
...
R160_2D = D2(R160, T0, T1, SUM_R160_N_H)
R180_2D = D2(R180, T0, T1, SUM_R180_N_H)
R240_2D = D2(R240, T0, T1, SUM_R240_N_H)
R288_2D = D2(R288, T0, T1, SUM_R288_N_H)
