...
#%%
dir1 = "/net/labdata/yi/basilisk/Experiment/3D_idealize/PARA/ROTA/fan_goal_180R_position/"
...
DR_R180 = D2_N(R180, 0, T0)
DR_R192 = D2_N(R192, 0, T0)
DR_R240 = D2_N(R240, 0, T0)
DR_R288 = D2_N(R288, 0, T0)
DR_R320 = D2_N(R320, 0, T0)
DR_R360 = D2_N(R360, 0, T0)
...
DO_R140 = D2_N(R140, T0, T1)
DO_R160 = D2_N(R160, T0, T1)
DO_R180 = D2_N(R180, T0, T1)
DO_R192 = D2_N(R192, T0, T1)
DO_R240 = D2_N(R240, T0, T1)
DO_R288 = D2_N(R288, T0, T1)
DO_R320 = D2_N(R320, T0, T1)
DO_R360 = D2_N(R360, T0, T1)
...
OAEF_R180 = (DO_R180-DR_R180)/(TC_hub - DR_R180)*100
OAEF_R192 = (DO_R192-DR_R192)/(TC_hub - DR_R192)*100
OAEF_R240 = (DO_R240-DR_R240)/(TC_hub - DR_R240)*100
OAEF_R288 = (DO_R288-DR_R288)/(TC_hub - DR_R288)*100
OAEF_R320 = (DO_R320-DR_R320)/(TC_hub - DR_R320)*100
OAEF_R360 = (DO_R360-DR_R360)/(TC_hub - DR_R360)*100
OAEF_R480 = (DO_R480-DR_R480)/(TC_hub - DR_R480)*100  

np.save("PARA_ROTA/OAEF_R060.npy", OAEF_R060)
np.save("PARA_ROTA/OAEF_R080.npy", OAEF_R080)
np.save("PARA_ROTA/OAEF_R096.npy", OAEF_R096)
np.save("PARA_ROTA/OAEF_R120.npy", OAEF_R120)
np.save("PARA_ROTA/OAEF_R140.npy", OAEF_R140)
np.save("PARA_ROTA/OAEF_R160.npy", OAEF_R160)
np.save("PARA_ROTA/OAEF_R180.npy", OAEF_R180)
np.save("PARA_ROTA/OAEF_R192.npy", OAEF_R192)
np.save("PARA_ROTA/OAEF_R240.npy", OAEF_R240)
np.save("PARA_ROTA/OAEF_R288.npy", OAEF_R288)
np.save("PARA_ROTA/OAEF_R320.npy", OAEF_R320)
np.save("PARA_ROTA/OAEF_R360.npy", OAEF_R360)
np.save("PARA_ROTA/OAEF_R480.npy", OAEF_R480)
