...
#%%
dir1 = "/net/labdata/yi/basilisk/Experiment/3D_idealize/PARA/ROTA_LD/HAR/"
...
np.save("HAR_DS/OAEF_R060.npy", OAEF_R060)
np.save("HAR_DS/OAEF_R080.npy", OAEF_R080)
np.save("HAR_DS/OAEF_R096.npy", OAEF_R096)
np.save("HAR_DS/OAEF_R120.npy", OAEF_R120)
np.save("HAR_DS/OAEF_R160.npy", OAEF_R160)
np.save("HAR_DS/OAEF_R192.npy", OAEF_R192)
np.save("HAR_DS/OAEF_R240.npy", OAEF_R240)
np.save("HAR_DS/OAEF_R320.npy", OAEF_R320)
np.save("HAR_DS/OAEF_R480.npy", OAEF_R480)
